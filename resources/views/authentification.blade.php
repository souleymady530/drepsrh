...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background:rgb(251,251,251)">
            ...
            <div class="row" >
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 panCol">
            <span class="text"><a href="{{url('/')}}"> DREPS <br> RH</a></span>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 panForm">
